...
#make dirs
file_paths = ["./predicted2","./predicted","./ground_truth","./convert_file","./convert_file/predicted","./convert_file/ground_truth","./convert_file/predicted/tmp","./convert_file/ground_truth/tmp"]
for file_path in file_paths :
    if not os.path.exists(file_path):
        os.makedirs(file_path)
#convert darkflow json files and voc xml files to txt files
cj.convert('predicted')
cx.convert()
