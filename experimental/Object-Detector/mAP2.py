...
#make dirs
file_paths = ["./convert_file/predicted2/tmp","./convert_file/predicted2","./predicted2","./predicted","./ground_truth","./convert_file","./convert_file/predicted","./convert_file/ground_truth","./convert_file/predicted/tmp","./convert_file/ground_truth/tmp"]
for file_path in file_paths :
    if not os.path.exists(file_path):
        os.makedirs(file_path)
#convert darkflow json files and voc xml files to txt files
cj.convert('predicted2')
cx.convert()

ground_truth_files = glob.glob("./convert_file/ground_truth/*.txt")
ground_truth_files.sort()
predicted_files = glob.glob("./convert_file/predicted2/*.txt")
...
for label in gt_label:
    ...
    with open("./convert_file/predicted2/tmp/" + label + "_p.json", 'w') as out:
        json.dump(p_bbox, out)
#Calculate ap
sum_AP = 0.0
result_text = ""
for label in gt_label:
    p_file = "./convert_file/predicted2/tmp/" + label + "_p.json"
